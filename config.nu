...
$env.config = {
    ...
    color_config: $catppuccin_latte_theme # if you want a more interesting theme, you can replace the empty record with `$dark_theme`, `$light_theme` or another custom record
